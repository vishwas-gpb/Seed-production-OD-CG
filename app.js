...
async function dashboard(){ farmersDashboard(); renderMap([]); const all=await idbAll();
...
function chartBar(id,obj,limit,horizontal){ if(typeof Chart==="undefined"){ bars(id,obj,limit); return; }
...
function chartDoughnut(id,obj){ if(typeof Chart==="undefined"){ bars(id,obj); return; }
