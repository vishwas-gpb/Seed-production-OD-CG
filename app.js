...
function applyRole(role){ const viewer=(role==="viewer"); el("tab-new").style.display=viewer?"none":""; el("tab-rec").style.display=viewer?"none":""; if(viewer){ el("who").textContent+=" (view only)"; showView("dash"); } }
